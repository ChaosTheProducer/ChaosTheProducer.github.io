...
export default function Profile({ author, social, features, researchInterests }: ProfileProps) {
    ...
    const hasLocationDetails = Boolean(social.location_details && social.location_details.length > 0);
    ...
    const socialLinks = [
        ...
        ...(social.location || hasLocationDetails ? [{
        ...
        ...(social.xiaohongshu ? [{
            ...
            image: '/social-icons/rednote.png',
        }] : []),
    ];

    return (
        <motion.div initial={false} className="sticky top-8">
            {/* Profile Image */}
